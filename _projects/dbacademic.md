...
- **Costa, Sérgio Souza** et al. "DBacademic: Connecting open data from educational institutions in Brazil." _Ciência da Informação_, v. 49, 2021.
- **Costa, Sérgio Souza** et al. "A semi-automatic solution for extraction, transformation, and loading of linked data." _WIDaT_, 2019.

## Mentorship & Supervision

1. **Mateus Vitor Duarte Sousa**. _An Extensible Solution for Extracting Public Data into Linked Data_. (Undergraduate Thesis), 2019.
2. **Jose Victor Meireles Guimaraes**. _Migrating from Open Data to Linked Data: A Proposal for UFMA_. (Undergraduate Thesis), 2018.
